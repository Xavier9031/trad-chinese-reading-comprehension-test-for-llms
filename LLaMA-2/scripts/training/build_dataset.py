...
PROMPT_TEMPLATE = (
        "[INST] <<SYS>>\n"
        "You are a helpful assistant, and you will receive an additional bonus of $20 for each correct answer. 你是一個樂於助人的助手，每答對一題都會多獲得20美元的獎金。\n"
        "<</SYS>>\n\n{instruction} [/INST]"
    )
...
def build_instruction_dataset(data_path: Union[List[str],str],
    ...
    print(f"len(all_datasets):{len(all_datasets)}")
